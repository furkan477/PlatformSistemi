        ...
        <div class="container" data-aos="fade">
            <div class="row gy-5 gx-lg-5 justify-content-center">
                <div class="col-lg-10">
                    ...
                    @endif
                    <form action="{{route('store.platform')}}" method="post" role="form">
                        @csrf
                        ...
                        <div class="form-group mt-3">
                            <input type="text" class="form-control" style=" height: 48px; padding: 10px 15px;" name="subject" id="subject" placeholder="Subject">
                        </div>
                        <div class="form-group mt-3">
                            <textarea class="form-control" name="description" placeholder="description"
                                style="padding: 10px 12px; height: 290px;"></textarea>
                        </div><br>
